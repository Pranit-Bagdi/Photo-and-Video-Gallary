...
urlpatterns=[
    ...
    path('videos/<int:album_id>',views.videos,name='videos'),
    path('accounts/signup',views.signup,name='signup'),
    path('dashboard',views.dashboard,name='dashboard'),
    path('user-albums',views.user_albums,name='user-albums'),
    path('video-albums',views.video_albums,name='video-albums'),
    ...
    path('video-list/<int:album_id>',views.video_list,name='video_list'),
    ...
    path('add-video/<int:album_id>',views.add_video,name='add-video'),
]
